...
CREATE TABLE `categories_stores` (
  ...
  UNIQUE KEY `sId-cId-uniq` (`sId`,`cId`)
...
LOCK TABLES `categories_stores` WRITE;
/*!40000 ALTER TABLE `categories_stores` DISABLE KEYS */;
/*!40000 ALTER TABLE `categories_stores` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-12-02 13:36:52
