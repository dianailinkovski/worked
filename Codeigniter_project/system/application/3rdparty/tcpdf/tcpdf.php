	...
	public function Footer() {
		...
		if ($this->getRTL()) {
			$this->SetX($this->original_rMargin);
                        ...
                        //$this->MultiCell(145, 0, $barcode, 'T', 'R', 0, 2, '', '', true, 0);
                        //$this->SetTextColor(0, 0, 0);
                        //$this->MultiCell(40, 0, $pagenumtxt, 'T', 'L', 0, 2, '', '', true, 0);
			//$this->Cell(0, 0, $pagenumtxt, 'T', 0, 'L');
                        $this->MultiRow($pagenumtxt, $barcode);
		} else {
			$this->SetX($this->original_lMargin);
      //$this->Cell(0, 0, $this->getAliasRightShift().$this->PageNo().'/'.$this->getAliasNbPages(), 1, 0, 'R');
      $pagenumtxt = $this->PageNo();
      $this->SetTextColor(102, 102, 102);
      $this->MultiRow($barcode, $pagenumtxt);
      //$this->MultiCell(145, 0, $barcode, 'T', 'L', 0, 2, '', '', true, 0);
      //$this->SetTextColor(0, 0, 0);
      //$this->MultiCell(40, 0, $pagenumtxt, 'T', 'R', 0, 2, $this->GetX(), $this->GetY(), true, 0);
		}
	}
  ...
  public function getAliasRightShift() {
    ...
    return $alias;
        ...
        public function MultiRow($left, $right) {
            ...
            // write the left cell
            $this->MultiCell(165, 0, $left, 'T', 'L', 0, 2, '', '', true, 0);
            ...
            $this->MultiCell(22, 0, trim($right), 'T', 'R', 0, 2, $this->GetX(), $y_start, true, 0);
