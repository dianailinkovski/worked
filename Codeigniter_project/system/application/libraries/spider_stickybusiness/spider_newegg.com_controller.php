...
require_once 'spider_newegg.com_parser.php';
require_once 'spider_lib_ag/spider_controller.php';

class Spider_NeweggCom_Controller extends Spider_Controller {

    public function __construct() {
        parent::__construct('http://www.newegg.com/', new Spider_NeweggCom_Parser());
    }
    ...
    public function search($keyword) {
        $results = array();
        for ($href = '/Product/ProductList.aspx?Submit=ENE&' . http_build_query(array('Description' => $keyword)); $href !== null; $href = $this->getParser()->parseSearchResultPagination($xph)) {
