<?php
require_once 'spider_vitaminshoppe.com_parser.php';
require_once 'spider_lib_ag/spider_controller.php';

class Spider_VitaminshoppeCom_Controller extends Spider_Controller
{
	
	public function __construct()
	{
		parent::__construct( 'http://www.vitaminshoppe.com/', new Spider_VitaminshoppeCom_Parser() );
	}
	...
	{
		$results=array();
		for($href= 'http://www.vitaminshoppe.com/search/controller?N=0&Ntk=SiteSearch&'
				. http_build_query(array('Ntt' => $keyword));
			$href !== null;
