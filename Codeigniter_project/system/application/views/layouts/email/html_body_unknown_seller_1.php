<table id="letter" width="650" border="0" cellspacing="0" cellpadding="0" style="margin: 50px;">
	...
	<tr style="font-weight: bold">
		<td>
			<span style="margin-left: 50px; font-style: italic">Re:	&emsp;Violation of  #CompanyName MAP Policy</span><br /><br />
		</td>
	</tr>
	<tr id="body1">
		<td>
			To #SellerName,<br /><br />
				...
				&emsp;&emsp;You are receiving this letter because you are in violation of the Minimum Advertised Pricing Policy (the "<u>MAP Policy</u>") of #CompanyName (the "<u>Company</u>").  Evidence of this violation is included as <u>Attachment 1</u> to this letter.<br /><br />
		</td>
	</tr>
	...
	<tr id="body2">
		<td>
				&emsp;&emsp;To avoid final action by the Company, call us immediately, and no later than 24 hours from your receipt of this letter, at the following number: #Phone.  If you do not, we will use all available resources to protect our products, including actions necessary to suspend your operations and the operations of your suppliers.<br /><br />
