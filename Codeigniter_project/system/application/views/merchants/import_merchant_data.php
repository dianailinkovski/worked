<div class="panel panel-default">
    ...
    <div class="panel-heading" id="section-content-title">
        <h3 class="panel-title">
            <strong>Import Merchant Data</strong>
        </h3>
    </div>
    ...
    <div class="panel-body">
        ...
        <div id="panel-breadcrumbs">
            ...
            <i class="fa fa-angle-right"></i> Merchant Data
        </div>
        ...
        <form action="/merchants/import_merchant_data" method="post" enctype="multipart/form-data">

            <p>
                Use the following field to select and upload your merchant data CSV file. With each upload, we will version the data
            ...
            <p>
                <input class="btn btn-success" value="Import Merchant Data" type="submit" name="import_merchant_data_submit" />
            </p>
