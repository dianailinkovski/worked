<div class="panel panel-default">
    <div class="panel-heading">
        Tracked Product Listings - Last 180 Days
    </div>
    <div class="panel-body">
        <div id="flot-daily-products-tracked">
            <?php if (empty($data_points)): ?>
                <p>
                    No product tracking statistics are available.
                </p>
            <?php endif; ?>
        </div>
    </div>
...
<?php if (!empty($data_points)): ?>
    ...
    if ($('#flot-daily-products-tracked').length) {
        ...
        var plot = $.plot($("#flot-daily-products-tracked"),
            [ { data: series1,
                //label: "Series 1",
                //color: "#8cc152"
                color: "#00a0d1"
        ...
        $("#flot-daily-products-tracked").bind("plothover", function (event, pos, item) {
            ...
            if (item) 
            {
                if (previousPoint != item.dataIndex) 
                {
                    ...
                    showTooltip(item.pageX, item.pageY, y + ' product listings tracked ' + data_date);
                }
        ...
        $("#flot-daily-products-tracked").bind("plotclick", function (event, pos, item) {
            if (item) {
