<div class="panel panel-default">
    ...
    <div class="panel-heading" id="section-content-title">
        <h3 class="panel-title">
            <strong>Merchant Violation Summary</strong>
        </h3>
    </div>
    ...
    <div class="panel-body">
        ...
        <div id="panel-breadcrumbs">
            ...
            <i class="fa fa-angle-right"></i> Merchant Violation Summary
        </div>
        
        <div id="filters">
            <form action="/violationoverview/merchant_report" method="post">
        ...
        <div id="report-area">
            <table class="table table-bordered table-striped table-success table-responsive exportable reportTable" id="merchant-violation-summary">
                <thead>
                    <tr>
                	      ...
                	      <th align="left">Website</th> 
                		    ...
                		    <?php endforeach; ?>
							  ...
							  <tbody>
							      <?php foreach ($merchant_id_array as $merchant_id): ?>
							          <tr>
    							          <td>
    							              <a href="/merchants/profile/<?php echo $merchant_id; ?>"><?php echo $merchant_names[$merchant_id]; ?></a>
    							          </td>
    							          <td>
    							              <?php echo $merchant_websites[$merchant_id]; ?>
    							          </td>
    							          <?php foreach ($month_index_array as $month_index): ?>
    							              <td>
    							                  <?php if (isset($monthly_data[$month_index][$merchant_id])): ?>
    							                      <?php echo $monthly_data[$month_index][$merchant_id]; ?>
    							                  <?php else: ?>
    							                      N/A
    							                  <?php endif; ?>    
    							              </td>
...
$(document).ready(function() {
    ...
    var table = $('#merchant-violation-summary').DataTable({
        "stateSave": true,
        "lengthMenu": [[10, 50, 100, -1], [10, 50, 100, "All"]],
        "stateSaveCallback": function (settings, data) {
            $.ajax({
                "url": "/ajax/table_state_save/merchant-violation-summary",
                "data": data,
                "dataType": "json",
                "type": "POST",
                "success": function () {}    
        ...
        "stateLoadCallback": function (settings) {
            ...
            $.ajax({
              "url": "/ajax/table_state_load/merchant-violation-summary",
              "async": false,
              "dataType": "json",
