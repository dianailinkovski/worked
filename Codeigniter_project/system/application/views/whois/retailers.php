<div class="panel panel-default">
    ...
    <div class="panel-heading" id="section-content-title">
        <h3 class="panel-title">
            <strong>Retailers Selling My Products</strong>
        </h3>
    </div>
    ...
    <div class="panel-body">
        ...
        <div id="panel-breadcrumbs">
            ...
            <i class="fa fa-angle-right"></i> Retailers
        </div>
        ...
        <section id="repChartContainer"></section>
            ...
            <?php endif; ?>
				...
				<section id="sellingRetailers"><?=$this->load->view('components/sellingRetailers', '', TRUE)?></section>
