...
class Bluga_Webthumb {
    ...
    public function addUrl($url, $size='small', $width=300, $height=300, $excerpt_w=710, $excerpt_h=310)

    {
	    ...
	    $job = new Bluga_Webthumb_Job($excerpt_w, $excerpt_h);
