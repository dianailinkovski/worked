...
(function ($) {
    ...
    var FORMTMPL = ['<div class="modal"><div class="riform modal-dialog"><div class="modal-content">',
            '<form class="form-horizontal">',
                '<div class="modal-header"><button class="close" aria-hidden="true" data-dismiss="modal" type="button">×</button><h4 id="mySmallModalLabel" class="modal-title">${i18n.title}</h4></div>',
                '<div id="messagearea" style="display: none;">',
                '</div>',
                '<div class="modal-body"><div id="rirtemplate" class="widget-body">',
                        ...
                        '<div class="field">',
                          ...
                          '{{/if}}',
                            '<div>',
                                ...
                                '</label>',
                                '<input',
                                    'type="text" size="3" class="form-control"',
                                    'value="7"',
