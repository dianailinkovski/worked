...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tabs = React.createClass({
	  ...
	  render:function () {
	    var className = classNames('tabbable', this.props.className);
	    return (
	  ...
	  _getMenuItems:function () {
	    ...
	    return (
	        React.createElement("ul", {className: "nav nav-tabs"}, $menuItems)
	    );
	  },
	  _getSelectedPanel:function () {
	    ...
	    return (
	      React.createElement("div", {ref: "tab-panel", className: "tab-content"}, 
	        $panel
	      )
	    );
	  }
