...
public class EmptyMarkKioskArrayAdapter extends ArrayAdapter<EditionModelClass> {
	
	boolean showDateBool;
	boolean showDayBool;
	private Context mContext;
	
	public EmptyMarkKioskArrayAdapter(Context context, int textViewResourceId, ArrayList<EditionModelClass> items, Boolean showdate, Boolean showDay) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView imageView = (ImageView) convertView.findViewById(R.id.nciv_pug);        
