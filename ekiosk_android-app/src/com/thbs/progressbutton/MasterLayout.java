...
public class MasterLayout extends FrameLayout /*implements OnClickListener*/ {
	...
	private void setpaint() {
		...
		stroke_color.setColor(Color.rgb(240, 115, 0)); // Edit this to change
														// the circle color
		stroke_color.setStrokeWidth(8);
		stroke_color.setStyle(Paint.Style.STROKE);

		icon_color = new Paint(Paint.ANTI_ALIAS_FLAG);
		icon_color.setColor(Color.rgb(240, 115, 0));
		...
		fill_color.setColor(Color.rgb(240, 115, 0)); // Edit this to change the
														// circle fill color
