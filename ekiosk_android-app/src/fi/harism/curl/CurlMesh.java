...
public class CurlMesh {
	...
	public final CurlPage mTexturePage = new CurlPage();
	...
	public synchronized void setFlipTexture(boolean flipTexture) {
		...
		//Log.e("sidepage", String.valueOf(curling));
		
		/*
		if (sidePage == CurlRenderer.PAGE_LEFT && flipTexture == true) {
				setTexCoords(1f, 0f, 0f, 1f);
				//setTexCoords(0f, 0f, 1f, 1f);
		}
		else if (sidePage == CurlRenderer.PAGE_LEFT && flipTexture == false) {
			//setTexCoords(1f, 0f, 0f, 1f);
			setTexCoords(0f, 0f, 1f, 1f);
		}
		else if (sidePage == CurlRenderer.PAGE_RIGHT && flipTexture == true) {
			setTexCoords(1f, 0f, 0f, 1f);
			//setTexCoords(0f, 0f, 1f, 1f);
		}
		else if (sidePage == CurlRenderer.PAGE_RIGHT && flipTexture == false) {
			//setTexCoords(1f, 0f, 0f, 1f);
			setTexCoords(0f, 0f, 1f, 1f);
		}
		else {
