...
public class CurlPage {
	...
	public void recycle() {
		...
		mTextureFront = Bitmap.createBitmap(1, 1, Bitmap.Config.ARGB_8888);
		//mTextureFront.eraseColor(mColorFront);
		if (mTextureBack != null) {
			mTextureBack.recycle();
		}
		mTextureBack = Bitmap.createBitmap(1, 1, Bitmap.Config.ARGB_8888);
	...
	public void reset() {
		...
		//mColorBack = Color.argb(255, 32, 40, 48);
		mColorBack = Color.argb(255, 255, 255, 255);
		//mColorFront = Color.WHITE;
		mColorFront = Color.argb(255, 255, 255, 255);
		//mColorFront = Color.argb(255, 32, 40, 48);
		recycle();
	}
	...
	public void setTexture(Bitmap texture, int side) {
		if (texture == null) {
			texture = Bitmap.createBitmap(1, 1, Bitmap.Config.ARGB_8888);
			if (side == SIDE_BACK) {
